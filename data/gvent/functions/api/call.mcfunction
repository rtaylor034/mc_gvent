...
data modify storage gvent:var call.macro.info set from storage gvent:dirty call.stack[-1].info
data modify storage gvent:var call.macro.pass set value "gvent:dirty call.stack[-1].pass"
